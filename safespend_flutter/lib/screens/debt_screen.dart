                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                              ...
                                              if (hasDeadline)
                                                Text('Due: ${DateFormat('MMM d, yyyy').format(DateTime.parse(goal.targetDate!))}',
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text('${cf.format(goal.currentAmount)} paid',
          ...
          child: SafeArea(
            child: SingleChildScrollView(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 12),
                Wrap(spacing: 10, runSpacing: 10, children: emojiOptions.map((e) {
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text(dueDate != null ? DateFormat('MMM d, yyyy').format(dueDate!) : 'Not set',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.pop(ctx);
                      messenger.showSnackBar(SnackBar(content: Text('"$debtName" added'), backgroundColor: AppTheme.error));
                    },
                    style: ElevatedButton.styleFrom(
